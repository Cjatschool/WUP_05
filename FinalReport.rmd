...
Out of the three tests ran, all showed p-values that were too low so the chances of recreating the same results are unlikely, so we reject the null hypothesis.
